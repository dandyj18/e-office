...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Surat Keluar</a></li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="{{ url('admin/update', $keluar->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <div class="mb-3">
                                    <input type="text" class="form-control input-rounded" name="no_suratkeluar" required="required"  value="{{ $keluar->no_suratkeluar }}">
                                </div>
                                <div class="mb-3">
                                    <select class="custom-select mr-sm-2 rounded" name="users_id" required="required" aria-label="Default select example">
                                        
                                        <option value="{{ $keluar->users->id }}" selected>{{ $keluar->users->name }}</option>
                                        @foreach($users as $u)
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control input-rounded" name="perihal_keluar" required="required"  value="{{ $keluar->perihal_keluar }}">
                                </div>
                                <div class="mb-3">
                                    <input type="date" class="form-control input-rounded" id="date" name="tgl_keluar" required="required" value="{{ $keluar->tgl_keluar }}">
                                </div>
                                <div class="mb-3">
